...
class _Modulo2AprendizajeLightState extends State<Modulo2AprendizajeLight> {
  ...
  void _goToModulo1() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const ModuloAprendizaje()),
    ).then((_) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: const Color(0xFFBFE5F0)),
        ),
        child: Row(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(color: const Color(0xFF607D8B), width: 2),
                color: Colors.white,
              ),
              child: Center(
                child: Text(
