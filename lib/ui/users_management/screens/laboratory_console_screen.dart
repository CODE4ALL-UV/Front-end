...
class LaboratoryConsoleScreen extends StatefulWidget {
  ...
  @override
  State<LaboratoryConsoleScreen> createState() =>
      _LaboratoryConsoleScreenState();
}

class _LaboratoryConsoleScreenState extends State<LaboratoryConsoleScreen> {
...
class _ExpressionParser {
  ...
  dynamic _parsePrimary() {
    ...
    throw FormatException('Token inesperado: $char');
  }

  String _parseString() {
    final quote = source[_position];
    _position++;
    ...
    throw FormatException('Cadena sin cerrar');
  }
  ...
  int _parseNumber() {
    ...
    return int.parse(source.substring(start, _position));
  }
