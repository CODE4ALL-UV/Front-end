    ...
    return Row(
      ...
      children: [
        ...
        SocialAuthButton(
          ...
          paddingSize: 16.0, // 👈 Dejamos a 16px para que no resalte tanto
          icon: SvgPicture.asset(
            AssetsRoutes.googleIcon,
            fit: BoxFit.contain,
            height:
                15, // Ajustamos el tamaño del ícono dentro del botón circular
            // Así se manejan los fallos en SvgPicture para evitar pantallas rotas
            placeholderBuilder: (BuildContext context) =>
                const Icon(Icons.g_mobiledata, color: Colors.red, size: 18),
          ),
