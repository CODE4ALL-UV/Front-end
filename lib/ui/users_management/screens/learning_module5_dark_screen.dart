...
class Modulo5AprendizajeDark extends StatefulWidget {
  const Modulo5AprendizajeDark({super.key});

  @override
  State<Modulo5AprendizajeDark> createState() => _Modulo5AprendizajeDarkState();
}

class _Modulo5AprendizajeDarkState extends State<Modulo5AprendizajeDark> {
  ...
  void _goToModulo6() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const Modulo6AprendizajeDark()),
    ).then((_) {
                    ...
                    Row(
                      ...
                      children: [
                        _BigCircle(
                          ...
                          bgColor: const Color(0xFF2C2A18),
                          size: bigSize,
                          progress: 0.75,
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const Capitulo3AnalisisProblemasDark(),
                              ),
                            );
                          },
                        ),
                        ...
                        _LessonBox(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    const Capitulo2ComponentesAlgoritmoDark(),
                              ),
                            );
                          },
                        ),
                        ...
                        _BigCircle(
                          ...
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => const Capitulo1AlgoritmosDark(),
                              ),
                            );
                          },
                        ),
...
class Capitulo1AlgoritmosDark extends StatelessWidget {
  const Capitulo1AlgoritmosDark({super.key});

  @override
  Widget build(BuildContext context) {
    return _ChapterDetailDark(
      chapterTitle: 'Capítulo 1: Algoritmos',
      moduleLabel: 'Módulo 5. Metodología para resolver problemas',
      rutaItems: const [
        _ActivityItem('Características de un algoritmo', '📚🖥️🎧'),
        _ActivityItem('Nombre del Tip/Cápsula de conocimiento', '🎁'),
        _ActivityItem('Ejemplo', '⚙️'),
        _ActivityItem('Tipos de algoritmos', '📚🖥️🎧'),
        _ActivityItem('Nombre del Tip/Cápsula de conocimiento', '🎁'),
        _ActivityItem('Ejercicio', '🏋️'),
        _ActivityItem('Casos de uso', '📚🖥️🎧'),
      ...
      onNextChapter: () => Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const Capitulo2ComponentesAlgoritmoDark(),
        ),
      ),
    );
  }
...
class Capitulo2ComponentesAlgoritmoDark extends StatelessWidget {
  const Capitulo2ComponentesAlgoritmoDark({super.key});

  @override
  Widget build(BuildContext context) {
    return _ChapterDetailDark(
      chapterTitle: 'Capítulo 2: Componentes de un algoritmo',
      moduleLabel: 'Módulo 5. Metodología para resolver problemas',
      rutaItems: const [
        _ActivityItem('Input o entrada', '📚🖥️🎧'),
        _ActivityItem('Nombre del Tip/Cápsula de conocimiento', '🎁'),
        _ActivityItem('Ejemplo', '⚙️'),
        _ActivityItem('Proceso o instrucciones', '📚🖥️🎧'),
        _ActivityItem('Nombre del Tip/Cápsula de conocimiento', '🎁'),
        _ActivityItem('Ejercicio', '🏋️'),
        _ActivityItem('Output o salida', '📚🖥️🎧'),
        _ActivityItem('Nombre de la buena práctica', '🏅'),
        _ActivityItem('Quiz', '❓'),
        _ActivityItem('Laboratorio', '🧪'),
        _ActivityItem('Evaluación final', '📋'),
      ...
      onPreviousChapter: () => Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (_) => const Capitulo1AlgoritmosDark()),
      ),
      onNextChapter: () => Navigator.pushReplacement(
        context,
        MaterialPageRoute(
          builder: (_) => const Capitulo3AnalisisProblemasDark(),
        ),
      ),
    );
  }
...
class Capitulo3AnalisisProblemasDark extends StatelessWidget {
  const Capitulo3AnalisisProblemasDark({super.key});

  @override
  Widget build(BuildContext context) {
    return _ChapterDetailDark(
      chapterTitle: 'Capítulo 3: Análisis de problemas',
      moduleLabel: 'Módulo 5. Metodología para resolver problemas',
      rutaItems: const [
        _ActivityItem('¿En qué consiste?', '📚🖥️🎧'),
        _ActivityItem('Nombre del Tip/Cápsula de conocimiento', '🎁'),
        _ActivityItem('Ejemplo', '⚙️'),
        _ActivityItem('El principio de Pareto', '📚🖥️🎧'),
        _ActivityItem('Nombre del Tip/Cápsula de conocimiento', '🎁'),
        _ActivityItem('Ejercicio', '🏋️'),
        _ActivityItem('Aprender haciendo', '📚🖥️🎧'),
        _ActivityItem('Nombre de la buena práctica', '🏅'),
        _ActivityItem('Quiz', '❓'),
        _ActivityItem('Laboratorio', '🧪'),
        _ActivityItem('Evaluación final', '📋'),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: const Color(0xFF6D5F2A)),
        ),
        child: Row(
          children: [
            Container(
